...
<head>
  ...
  <link rel="stylesheet" href="//alyocord.albishehu.repl.co/chat/style.css">
  ...
  <script src='//alyocord.albishehu.repl.co/chat/script.js'></script>
...
<body>
  ...
  <button style='background:transparent;border:none;' onclick='theme()' id='theme-trigger'><img src='//cdn1.iconfinder.com/data/icons/user-interface-16x16-vol-1/16/contrast-circle-512.png' height='20' width='20' style='display: none;'></button>
